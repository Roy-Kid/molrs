...
use super::options::Gen3DOptions;
use crate::core::molgraph::MolGraph;
use crate::core::rotatable::detect_rotatable_bonds_with_downstream;
...
pub(crate) fn run(
    ...
    let local_steps = match opts.speed {
        super::options::Gen3DSpeed::Fast => 6,
        super::options::Gen3DSpeed::Medium => 10,
        super::options::Gen3DSpeed::Better => 16,
    };
