...
//!
//! ```
//! use molrs::io::smiles::smarts::{SmartsPattern, SubstructureMatcher};
...
impl SmartsPattern {
    ...
    ///
    /// ```
    /// use molrs::io::smiles::smarts::SmartsPattern;
    ///
    /// let pat = SmartsPattern::compile("[C;X4]").unwrap();
...
fn bracket_to_query(
    isotope: Option<u16>,
    symbol: &crate::io::smiles::chem::ast::BracketSymbol,
    chirality: Option<crate::io::smiles::chem::ast::Chirality>,
    hcount: Option<u8>,
    charge: Option<i8>,
    atom_class: Option<u16>,
) -> AtomQuery {
    use crate::io::smiles::chem::ast::BracketSymbol;
