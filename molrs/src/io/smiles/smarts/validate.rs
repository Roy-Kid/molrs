...
use crate::io::smiles::chem::ast::SmilesIR;
...
/// [`SmilesErrorKind::UnmatchedRingClosure`](crate::io::smiles::error::SmilesErrorKind::UnmatchedRingClosure)
...
mod tests {
    use super::*;
    use crate::io::smiles::error::SmilesErrorKind;
