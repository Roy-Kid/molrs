...
use molrs::io::data::lammps_data::{LAMMPSDataReader, read_lammps_data, write_lammps_data};
...
fn all_lammps_data_files() -> Vec<PathBuf> {
    let dir = crate::common::data_path("lammps-data");
...
fn test_read_labelmap() {
    let path = crate::common::data_path("lammps-data/labelmap.lmp");
...
#[test]
fn test_read_molid() {
    let path = crate::common::data_path("lammps-data/molid.lmp");
...
fn test_read_triclinic() {
    let path = crate::common::data_path("lammps-data/triclinic-1.lmp");
...
fn test_read_triclinic_2() {
    let path = crate::common::data_path("lammps-data/triclinic-2.lmp");
...
fn test_read_whitespaces() {
    let path = crate::common::data_path("lammps-data/whitespaces.lmp");
...
fn test_read_solvated_system() {
    let path = crate::common::data_path("lammps-data/solvated.lmp");
