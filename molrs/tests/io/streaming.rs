...
use molrs::io::streaming::{FrameIndexBuilder, FrameIndexEntry};
...
mod xyz_streaming {
    use super::*;
    use molrs::io::data::xyz::{XYZReader, XyzIndexBuilder, parse_frame_bytes};
    use molrs::io::reader::TrajReader;
    use std::io::{BufReader, Cursor};
    ...
    #[test]
    fn methane() {
        run_one(&crate::common::data_path("xyz/methane.xyz"));
    }

    #[test]
    fn trajectory() {
        run_one(&crate::common::data_path("xyz/trajectory.xyz"));
    }

    #[test]
    fn extended() {
        run_one(&crate::common::data_path("xyz/extended.xyz"));
    }

    #[test]
    fn velocities() {
        run_one(&crate::common::data_path("xyz/velocities.xyz"));
    }

    #[test]
    fn topology() {
        run_one(&crate::common::data_path("xyz/topology.xyz"));
    }
}
...
mod pdb_streaming {
    use super::*;
    use molrs::io::data::pdb::{PdbIndexBuilder, parse_frame_bytes};
    ...
    fn single_frame_water() {
        ...
        run_one(&crate::common::data_path("pdb/water.pdb"), 1);
    }
    ...
    fn multi_model_2hkb() {
        ...
        let bytes = std::fs::read(&path).expect("read file");
        let one = build_index(
            || Box::new(molrs::io::data::pdb::PdbIndexBuilder::new()),
            &bytes,
            bytes.len(),
        );
...
mod sdf_streaming {
    use super::*;
    use molrs::io::data::sdf::{SDFReader, SdfIndexBuilder, parse_frame_bytes};
    ...
    #[test]
    fn aspirin() {
        run_one(&crate::common::data_path("sdf/aspirin.sdf"));
    }

    #[test]
    fn kinases_multi_record() {
        run_one(&crate::common::data_path("sdf/kinases.sdf"));
    }
}
