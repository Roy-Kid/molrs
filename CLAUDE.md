...
| `io` | `io` | File I/O: PDB, XYZ, LAMMPS data/dump, CHGCAR/POSCAR, Gaussian Cube, CIF, mol2, SDF, GRO, DCD, Zarr V3 trajectories; SMILES/SMARTS parsing in `io/smiles/` (gated by the `smiles` feature) |
