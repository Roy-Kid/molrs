...
class Graph:
    """General molecular graph (atoms or beads). Base of the hierarchy.

    Carries the full method surface; subclassable from Python with cooperative
    mixins — ``__new__`` accepts and ignores ``*args``/``**kwargs``.
    """
    ...
    def atom_keys(self, i: int) -> List[str]: ...
    def get_atom_prop(self, i: int, key: str) -> Union[int, float, str, None]: ...
    def set_atom_prop(self, index: int, key: str, value: Union[int, float, str]) -> None: ...
    def del_atom_prop(self, i: int, key: str) -> None: ...
    def atom_column(self, key: str) -> List[Union[int, float, str, None]]: ...
    def coords(self) -> List[List[float]]: ...
    def set_coords(self, rows: List[List[float]]) -> None: ...
    ...
    def get_bond_atoms(self, b: int) -> Tuple[int, int]: ...
    def bond_keys(self, b: int) -> List[str]: ...
    def get_bond_prop(self, b: int, key: str) -> Union[int, float, str, None]: ...
    def set_bond_prop(self, b: int, key: str, value: Union[int, float, str]) -> None: ...
    def del_bond_prop(self, b: int, key: str) -> None: ...
    def remove_bond(self, b: int) -> None: ...
    @property
    def n_bonds(self) -> int: ...
    # --- angles ---
    def add_angle(self, i: int, j: int, k: int) -> int: ...
    def get_angle_atoms(self, a: int) -> Tuple[int, int, int]: ...
    def angle_keys(self, a: int) -> List[str]: ...
    def get_angle_prop(self, a: int, key: str) -> Union[int, float, str, None]: ...
    def set_angle_prop(self, a: int, key: str, value: Union[int, float, str]) -> None: ...
    def del_angle_prop(self, a: int, key: str) -> None: ...
    def remove_angle(self, a: int) -> None: ...
    @property
    def n_angles(self) -> int: ...
    # --- dihedrals ---
    def add_dihedral(self, i: int, j: int, k: int, l: int) -> int: ...
    def get_dihedral_atoms(self, d: int) -> Tuple[int, int, int, int]: ...
    def dihedral_keys(self, d: int) -> List[str]: ...
    def get_dihedral_prop(self, d: int, key: str) -> Union[int, float, str, None]: ...
    def set_dihedral_prop(self, d: int, key: str, value: Union[int, float, str]) -> None: ...
    def del_dihedral_prop(self, d: int, key: str) -> None: ...
    def remove_dihedral(self, d: int) -> None: ...
    @property
    def n_dihedrals(self) -> int: ...
    # --- impropers ---
    def add_improper(self, i: int, j: int, k: int, l: int) -> int: ...
    def get_improper_atoms(self, m: int) -> Tuple[int, int, int, int]: ...
    def improper_keys(self, m: int) -> List[str]: ...
    def get_improper_prop(self, m: int, key: str) -> Union[int, float, str, None]: ...
    def set_improper_prop(self, m: int, key: str, value: Union[int, float, str]) -> None: ...
    def del_improper_prop(self, m: int, key: str) -> None: ...
    def remove_improper(self, m: int) -> None: ...
    @property
...
class Atomistic(Graph):
    """All-atom molecular graph (``add_atom`` writes ``element``)."""

    def __init__(self, *args: object, **kwargs: object) -> None: ...

class CoarseGrain(Graph):
    """Coarse-grained molecular graph (``add_bead`` writes ``bead_type``)."""
