...
//!
//! ```no_run
//! use molrs_io::trajectory::lammps_dump::{read_lammps_dump, open_lammps_dump, write_lammps_dump};
//!
...
///
/// ```no_run
/// use molrs_io::trajectory::lammps_dump::open_lammps_dump;
/// use molrs_io::reader::TrajReader;
///
/// # fn main() -> std::io::Result<()> {
...
///
/// ```no_run
/// use molrs_io::trajectory::lammps_dump::write_lammps_dump;
/// use molrs::store::frame::Frame;
///
/// # fn main() -> std::io::Result<()> {
