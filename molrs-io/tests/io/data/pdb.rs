...
use molrs::types::F;
use molrs_io::data::pdb::{read_pdb_frame, write_pdb_frame};
...
fn all_pdb_files() -> Vec<std::path::PathBuf> {
    let dir = crate::common::data_path("pdb");
...
fn test_water_elements() {
    let path = crate::common::data_path("pdb/water.pdb");
...
fn test_triclinic_simbox() {
    let path = crate::common::data_path("pdb/1vln-triclinic.pdb");
...
fn test_conect_bonds_present() {
    let path = crate::common::data_path("pdb/1avg.pdb");
...
fn test_hemoglobin_has_iron() {
    let path = crate::common::data_path("pdb/4hhb.pdb");
...
fn test_model_pdb_single_frame() {
    let path = crate::common::data_path("pdb/model.pdb");
